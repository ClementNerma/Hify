...
const r = (function () {
    ...
    return (
      ...
      (a.prototype = {
        ...
        map: function (t) {
          for (let r = this.vboxes, n = 0; n < r.size(); n++) if (r.peek(n).vbox.contains(t)) return r.peek(n).color
...
export class ColorThief {
  getColor(t: HTMLImageElement, r?: number): [number, number, number] {
    return void 0 === r && (r = 10), this.getPalette(t, 5, r)[0]
  }

  getPalette(t, o, e): [number, number, number][] {
    const i = (function (t) {
        let r = t.colorCount,
          n = t.quality
