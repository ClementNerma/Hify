...
function calcMeanCentroid(dataSet: number[][], start: number, end: number) {
...
function getRandomCentroidsNaiveSharding(dataset: number[][], k: number) {
...
function getDistanceSQ(a: number[], b: number[]): number {
  const diffs = []
...
function recalculateCentroids(dataSet: number[][], labels, k: number) {
